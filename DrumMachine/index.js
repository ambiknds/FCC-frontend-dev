        ...
        <div className="main" >
            ...
            <div className="text-center" id="display">
                ...
                {audioClips.map((clip) => (
                    ...
                    volume={volume} setRecording={setRecording}/>
                ))}
                </div>
                <br /><br />
                <h4>Volume</h4>
...
function Pad({clip, volume, setRecording}) {
    ...
    return (
        <div onClick={playSound} className={`btn btn-secondary p-4 m-3 ${active && "btn btn-warning"}`}>
